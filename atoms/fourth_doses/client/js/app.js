...
function init(results) {
	...
	var grey_colours = {"Second doses":"#d10a10", 'Fourth doses':'#e6711b'}
	...
	keys.forEach(function(key,i) {
		...
		if (greys.some(stringo => key.includes(stringo))){
			...
			console.log("Greys greys", stringo => key.includes(stringo))
		...
		}  else if(key.includes("Fourth doses")){
...
Promise.all([
	d3.json(`https://interactive.guim.co.uk/yacht-charter-data/oz-live-corona-page-second-boosters-fourth-doses-tracker.json`)
